...
<RELEASE/>
    ...
    def __init__(self, config: Dict):
        ...
        self.log_file = f'ena_datasource_{datetime.datetime.now().strftime("%Y%m%d_%H%M%S")}.txt'
    ...
    def generate_ena_ids_for_samples(self, manifest_id: str,
        ...
        submission_xml_file = self._build_submission_xml(manifest_id, self.contact_name,
                                                      self.contact_email)
    ...
    def _convert_xml_to_list_of_sample_dict(self, response_xml: str) -> List[Dict[str, List[str]]]:
        samples = []
    ...
    def _build_bundle_sample_xml(self, samples: Dict[str, Dict[str, List[str]]]) -> Tuple[str, int]:
    ...
    def _build_submission_xml(self, manifest_id: str, contact_name: str, contact_email: str) -> str:
    ...
    def _assign_ena_ids(self, samples: str, xml: str) -> Dict[str, Dict[str, List[str]]]:
    ...
    def _assign_biosample_accessions(self, samples: Dict[str, Dict[str, List[str]]],
